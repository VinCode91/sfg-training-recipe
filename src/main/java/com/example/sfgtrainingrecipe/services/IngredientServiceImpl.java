...
import com.example.sfgtrainingrecipe.converters.IngredientCommandToIngredient;
...
import com.example.sfgtrainingrecipe.repositories.IngredientRepository;
...
public class IngredientServiceImpl implements IngredientService {
    ...
    public IngredientCommand saveIngredientCommand(IngredientCommand command) {
        ...
        if (!recipeOptional.isPresent()) {
            ...
            //check by description // because we don't have new ingredient id
